...
export default class {
    constructor() {
        ...
        /**Debug gui */
        // this.gui.add(this.object.position, 'x').min(-50).max(50).step(1).name('planet position x')
        // this.gui.add(this.object.position, 'y').min(-50).max(50).step(1).name('planet position y')
        // this.gui.add(this.object.position, 'z').min(-50).max(50).step(1).name('planet position z')

        this.gui.add(this.object.rotation, 'x').min(-50).max(50).step(1).name('planet rotation x')
        this.gui.add(this.object.rotation, 'y').min(-50).max(50).step(1).name('planet rotation y')
        this.gui.add(this.object.rotation, 'z').min(-50).max(50).step(1).name('planet rotation z')
        ...
        this.gui.add(this.material.uniforms.uColor.value, 'r').name('color r')
        this.gui.add(this.material.uniforms.uColor.value, 'g').name('color g')
        this.gui.add(this.material.uniforms.uColor.value, 'b').name('color b')
        
        this.gui.addColor(this.material.uniforms, 'uColor1').onChange((color) => {
            this.material.uniforms.uColor1.value = color
        })

        this.gui.add(this.material.uniforms.uHoverState, 'value').min(0).max(6).step(0.5).name('hover state')
    ...
    createStars() {
        ...
        this.gui.add(this.starsMaterial.uniforms.uScale, 'value').min(0).max(6).step(0.05).name('star scale')
    }
